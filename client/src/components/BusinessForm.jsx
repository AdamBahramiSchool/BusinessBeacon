...
function BusinessForm() {
    ...
    const boxStyle = {
      ...
      return (
        <Box sx={{ display: 'flex', justifyContent: 'center', minHeight: '100vh',mt:'3rem' }}>
          <Box >
          ...
          <Box className='bn_container' sx={{ textAlign: 'center', ...boxStyle}}>
            ...
            <Box className='bl_container' sx={{ textAlign: 'center', ...boxStyle}}>
              <TextField id="outlined-basic" label="Business Location" variant="outlined" fullWidth />
            </Box>
            ...
            <Box className='pd_container' sx={boxStyle}>
              <TextField id="outlined-basic" label="Promotions/Deals" variant="outlined" fullWidth />
            </Box>

            <Box className='operationhours_container' sx={boxStyle}>
              <TextField id="outlined-basic" label="Operation Hours" variant="outlined" fullWidth />
            </Box>
